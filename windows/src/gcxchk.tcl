...
proc vTclWindow.top45 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 259x89+630+330; update
    ...
    entry $top.ent48 \
        -background white -textvariable "$top\::ent48" 
    ...
    ###################
    place $top.lab46 \
        -in $top -x 15 -y 15 -anchor nw -bordermode ignore 
    place $top.ent48 \
        -in $top -x 165 -y 15 -width 34 -height 19 -anchor nw \
        -bordermode ignore 
    place $top.but49 \
        -in $top -x 65 -y 45 -width 137 -height 34 -anchor nw \
        -bordermode ignore 
